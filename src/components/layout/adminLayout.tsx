  ...
  return (
    <div className='h-screen flex w-[102%]'>
      <div className="w-[15%] md:w-[8%] lg:w-[16%] xl:w-[14%]  border-e">
        <div className='w-full flex justify-center align-middle border-b'>
          <Link to="/" className={`flex items-center justify-center lg:justify-start gap-2 mt-1 textColor  h-[46px]`}>
